...
**Whenever you send a message to another agent** (e.g. via `wackypub agent <id> prompt "..."`), start the message text with a short preamble announcing your own agent ID, then continue with the actual content:
